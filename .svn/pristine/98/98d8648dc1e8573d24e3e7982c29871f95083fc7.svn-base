...
namespace Turkcell.Updater
{
    ...
    /// <ul>
    /// <li><see cref="KeyAppPackageId"/></li>
    /// <li><see cref="KeyAppVersion"/></li>
    /// <li><see cref="KeyDeviceOsName"/></li>
    /// <li><see cref="KeyDeviceOsVersion"/></li>
    /// <li><see cref="KeyDeviceBrand"/></li>
    /// <li><see cref="KeyDeviceId"/></li>
    /// <li><see cref="KeyDeviceIsTablet"/></li>
    /// <li><see cref="KeyDeviceLanguage"/></li>
    /// <li><see cref="KeyDeviceMcc"/></li>
    /// <li><see cref="KeyDeviceMnc"/></li>
    /// <li><see cref="KeyDeviceModel"/></li>
    /// <li><see cref="KeyDeviceScreenResolution"/></li>
    /// <li><see cref="KeyUpdaterLevel"/></li>
    /// </ul><br/>
    ...
    public class Properties
    {
        ...
        /// <summary>
        /// "true" if devices is a tablet, otherwise "false". For now <value>False</value> is returned because no tablets available with WP OS.
        ...
        /// <summary>
        /// Creates an instance and to retrive current device and application properties please call async <see cref="InitAsync()"/> method.
        /// </summary>
        private Properties()
        ...
        /// <returns></returns>
        public async static Task<Properties> CreateInstance(Dictionary<string, string> map = null)
        {
        ...
        /// </summary>
        /// <returns><see cref="Task"/> instance for the operation.</returns>
