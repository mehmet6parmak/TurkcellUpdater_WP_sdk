...
namespace Turkcell.Updater
{
    ...
    public class UpdaterException : Exception
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="UpdaterException"/> using provided exception. You can check the details looking at <see cref="Exception.InnerException"/> property.
        /// </summary>
        ...
        /// </summary>
        /// <param name="detailMessage"><see cref="Exception.Message"/></param>
