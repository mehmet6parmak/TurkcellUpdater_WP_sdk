...
namespace Turkcell.Updater
{
    ...
    /// <ul>
    /// <li><see cref="P:Turkcell.Updater.LocalizedStringMap.Item(System.String)"/> </li>
    /// <li><see cref="KeyTitle"/> </li>
    /// <li><see cref="KeyMessage"/> </li>
    /// <li><see cref="KeyImageUrl"/> </li>
    /// </ul>
    /// </summary>
    public class MessageDescription : LocalizedStringMap
    {
        ...
        /// </summary>
        public string Title { get { return this[KeyTitle]; } }

        /// <summary>
        /// Body of the <see cref="Message"/>.
        /// </summary>
        public string Body { get { return this[KeyMessage]; } }

        /// <summary>
        /// Url of the Image to be showed in <see cref="UpdaterDialog"/>.
        /// </summary>
        public string ImageUrl { get { return this[KeyImageUrl]; } }
