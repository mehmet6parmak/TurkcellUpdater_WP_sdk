...
namespace LitJson
{
    ...
    internal class JsonMapper
    {
        ...
        private static void AddArrayMetadata(Type type)
        {
            ...
            foreach (PropertyInfo p_info in type.GetRuntimeProperties())
            {
                if (p_info.Name != "Item")
                    continue;
        ...
        private static void AddObjectMetadata(Type type)
        {
            ...
            if (type.IsArray) // type.GetInterface("System.Collections.IDictionary", true) != null)
            ...
            foreach (FieldInfo f_info in type.GetRuntimeFields())
            {
                PropertyMetadata p_data = new PropertyMetadata();
                p_data.Info = f_info;
                p_data.IsField = true;
        ...
        private static MethodInfo GetConvOp(Type t1, Type t2)
        {
            ...
            MethodInfo op = t1.GetRuntimeMethod(
