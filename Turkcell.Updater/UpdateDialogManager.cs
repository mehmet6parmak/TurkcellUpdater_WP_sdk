...
namespace Turkcell.Updater
{
    ...
    public class UpdaterDialogManager
    {
        ...
        private void UpdateManagerUpdateCheckFailed(object sender, UpdateCheckFailedEventArgs e)
        {
            OnUpdateCheckFailed(e);
        }

        private void UpdateManagerNothingAvailable(object sender, EventArgs e)
        {
            OnUpdateCheckCompleted();
        }

        private void UpdateManagerMessageAvailable(object sender, MessageAvailableEventArgs e)
        {
        ...
        private void UpdateManagerUpdateAvailable(object sender, UpdateAvailableEventArgs e)
        {
            _update = e.Update;
            ...
            UpdateDescription updateDescription = _update.Description;
        ...
        ///     <ul>
        ///         <li>
        ///             New version is found and ready to install. Application should be
        ///             closed in order to launch new version.
        ///         </li>
        ///         <li>
        ///             User refused to install a mandatory update. See: <see cref="Update.ForceUpdate" />
        ///         </li>
        ///     </ul>
        /// </summary>
        ...
        {
            EventHandler<EventArgs> handler = ShouldExitApplication;
        ...
        {
            EventHandler<DisplayMessageEventArgs> handler = MessageAvailable;
        ...
        {
            EventHandler<EventArgs> handler = UpdateCheckCompleted;
            if (handler != null) handler(this, EventArgs.Empty);
        }
        ...
        private void DialogDismissed(object sender, EventArgs e)
        {
        ...
        /// </summary>
        /// <param name="message">
        ///     An instance of <see cref="Message" />
        /// </param>
        /// <returns>
        ///     An instance of <see cref="UpdaterDialog" />
        /// </returns>
