...
namespace Turkcell.Updater
{
    ...
    {
        /// <summary>
        ///     If this property set to <strong>true</strong> <see cref="UpdaterDialogManager" /> will fire the
        ///     <see
        ///         cref="UpdaterDialogManager.ShouldExitApplication" />
        ///     event if the user does not confirm the dialog.
        /// </summary>
        ...
        internal Update(UpdateDescription description, bool targetMarketplace, Version targetVersionCode,
                        Uri targetAppUriSchema, Uri targetWebSiteUrl, String targetPackageId, bool forceUpdate,
                        bool forceExit)
        {
