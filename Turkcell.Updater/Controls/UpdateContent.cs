...
namespace Turkcell.Updater.Controls
{
    ...
    public class UpdateContent : Control
    {
        ...
        public static readonly DependencyProperty MessageProperty =
            DependencyProperty.Register("Message", typeof (string), typeof (UpdateContent),
        ...
        public static readonly DependencyProperty WarningsProperty =
            DependencyProperty.Register("Warnings", typeof (string), typeof (UpdateContent),
                                        new PropertyMetadata(string.Empty, WarningsChanged));

        /// <summary>
        ///     Identifies the WhatIsNew dependency property.
        /// </summary>
        public static readonly DependencyProperty WhatIsNewProperty =
            DependencyProperty.Register("WhatIsNew", typeof (string), typeof (UpdateContent),
                                        new PropertyMetadata(string.Empty, WhatIsNewChanged));
