...
namespace Turkcell.Updater
{
    ...
    public class DisplayMessageEventArgs : EventArgs
    {
        ...
        /// <summary>
        ///     If this property is set to <strong>true</strong> <see cref="DisplayMessageEventArgs.Message" /> will be handled by application and displayed to the user later by calling
        ///     <see
        ///         cref="UpdaterDialogManager.CreateMessageDialog" />
        ///     .
        ///     <br />
