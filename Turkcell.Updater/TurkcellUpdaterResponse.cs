...
namespace Turkcell.Updater
{
    ...
    ///     Any <see cref="Turkcell.Updater.Message" /> and <see cref="Turkcell.Updater.Update" />'s are available through
    ///     <see
    ///         cref="Message" />
    ///     and <see cref="Update" /> properties.
    /// </summary>
    public class TurkcellUpdaterResponse
    {
        ...
        /// <summary>
        ///     Errors returned by Turkcell Updater Server or any exceptions occured while processing server responses. Http communication exceptions are not passed to application, you can only check status code via
        ///     <see
        ///         cref="StatusCode" />
        ///     property.
        /// </summary>
